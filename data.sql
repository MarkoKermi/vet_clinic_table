...
-- Insert data for Vets, specializations and visits
INSERT INTO vets (name, age, data_of_graduated) VALUES 
('William Tatcher', 45, '2000-04-23'), 
('Maisy Smith', 26, '2019-01-17'), 
('Stephanie Mendez', 64, '1981-05-04'), 
('Jack Harkness', 38, '2008-06-08');

INSERT INTO specializations (vets_id, species_id) VALUES ((select id FROM vets WHERE name = 'Wlliam Tatcher'), (SELECT id FROM species WHERE name = 'Pokemon'));
INSERT INTO specializations (vets_id, species_id) VALUES ((select id FROM vets WHERE name = 'Stephanie Mendez'), (SELECT id FROM species WHERE name = 'Digimon'), (SELECT id FROM species WHERE name = 'Pokemon'));
